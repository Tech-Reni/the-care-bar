...
if (str_contains($_SERVER['HTTP_HOST'], 'localhost')) {
    $BASE_URL = '/TheCareBar/'; // Local environment (adjust folder if needed)
} else {
    $BASE_URL = '../'; // Live environment
}

// ================================
// Database Credentials
// ================================
$servername = "localhost";      // Change if live server credentials differ
$username = "root";             // Change if live server credentials differ
$password = "";                 // Change if live server credentials differ
$dbname = "thecarebar";         // Database name
...
// Debug container for order creation
$ORDER_CREATE_DEBUG = [];

/**
 * Append debug info for order creation
 */
function order_debug_append($msg, $data = null) {
    global $ORDER_CREATE_DEBUG;
    $ORDER_CREATE_DEBUG[] = ['time' => date('c'), 'msg' => $msg, 'data' => $data];
}

/**
 * Get last order creation debug
 */
...
/**
 * Write order debug to log file (appends)
 */
